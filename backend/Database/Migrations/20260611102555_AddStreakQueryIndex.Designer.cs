...
namespace Backend.Database.Migrations
{
    ...
    [Migration("20260611102555_AddStreakQueryIndex")]
    partial class AddStreakQueryIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Database.Entities.UserExerciseProgress", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsCompleted", "CompletedAt");

                    b.ToTable("UserExerciseProgress");
                });

            modelBuilder.Entity("Backend.Database.Entities.UserLessonProgress", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnOrder(0);
                    ...
                    b.Property<int>("TotalPossibleXp")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Database.Entities.Users.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastTimesOnTopAt")
                        .HasColumnType("datetime2");
