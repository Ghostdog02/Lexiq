        ...
        IClassFixture<DatabaseFixture>
{
    ...
    [InlineData("GET", "/api/courses/test-id")]
    [InlineData("POST", "/api/courses")]
    [InlineData("PUT", "/api/courses/test-id")]
    [InlineData("DELETE", "/api/courses/test-id")]
    [InlineData("GET", "/api/lessons/course/test-id")]
    [InlineData("GET", "/api/lessons/test-id")]
